...
def main():
    ...
    print('F4 A1：右轮运动 SBUS 发射机失联停车 — 右轮正向 ≤5rpm / 不足3秒，左轮始终静止；反馈静止容差±1.5rpm；总就绪窗口60秒。\n')
    ...
    confirmation = dict(statement='F4右轮运动SBUS失联已上电就绪', raw_user_statement=answer,
                        confirmation_source='Local interactive terminal after displayed F4 A1 checklist',
