...
def main(incomplete=False):
    ...
    if incomplete:
        ...
        assert 'operation=control_hil_recovery context=phase=1 source_fault=9 ' in log
...
if __name__ == '__main__':
    ...
    parser.add_argument("--incomplete", action="store_true", help="Audit F5 A1 partial-frame discontinuity exit; never grant recovery acceptance")
