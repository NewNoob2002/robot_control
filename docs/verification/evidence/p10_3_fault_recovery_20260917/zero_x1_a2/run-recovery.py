...
REMOTE = '/home/cat/.cache/robot-control/staging/p103-faults-2f97bdba-x1-a2-20260917'
        ...
        with (BASE / 'recovery-execution.log').open('wb') as log:
            ...
            while application.poll() is None:
                ...
                if display != last_display:
                    print(f'\n[{phase}] {message}  提示窗口剩余约{remaining if remaining is not None else "?"}秒', flush=True)
