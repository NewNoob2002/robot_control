...
def main():
    ...
    assert 'event=stop_cause code=2 ' in log, 'This audit accepts cutoff restoration only, not F4'
    ...
    result={'status':'PASS_cutoff_protocol_and_restoration_only_NOT_F4_acceptance','matching_frames':len(records),
