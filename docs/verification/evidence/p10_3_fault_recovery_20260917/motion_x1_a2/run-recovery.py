...
REMOTE = '/home/cat/.cache/robot-control/staging/p103-right-throttle-778b0a79-x1-a2-20260917'
SHA = '778b0a79b4985b1040f2eccee1fbe6e948c8084a61e3c645db7a2a537d7ac611'
...
def main():
    ...
    assert confirmation['statement'] == 'F3右轮运动X1已上电就绪'
    assert confirmation['receiver_stays_powered'] and confirmation['motion_x1_stimulus']
