...
def main():
    ...
    print('F4 A5：右轮运动 SBUS 发射机失联停车 — 右轮正向 ≤5rpm / 不足8秒（7.95秒自动截止），左轮始终静止；反馈静止容差±1.5rpm；总就绪窗口60秒。\n')
    ...
    confirmation = dict(statement='F4右轮运动SBUS失联已上电就绪', raw_user_statement=answer,
                        confirmation_source='Local terminal START plus typed X1已复位，关闭遥控器 after F4 A5 checklist',
