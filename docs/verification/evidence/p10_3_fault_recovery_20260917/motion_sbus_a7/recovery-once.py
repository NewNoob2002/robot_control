...
SHA = 'cd8bd1c594c9297a9036ff585cdc82e852f99795c3f8a8c27e6bdd453d5df7a1'
BINARY = BASE / 'robot-control-hil'
ARGS = ['--interface', 'can0', '--device', '/dev/serial/by-id/usb-1a86_USB_Single_Serial_586D017868-if00', '--duration-ms', '60000', '--right-throttle', '--zero-feedback-tenths-rpm', '20', '--motion-window-ms', '8000']
...
def shutdown_prompt_due(contents, now, moving_since):
    ...
    if moving_since is None and any(int(value) > 20 for value in re.findall(
