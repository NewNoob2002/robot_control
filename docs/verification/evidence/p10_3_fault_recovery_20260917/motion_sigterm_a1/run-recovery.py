...
REMOTE = '/home/cat/.cache/robot-control/staging/p103-sigterm-91d3ce99-a1-20260917'
...
def main():
    ...
    assert confirmation['statement'] == 'F6右轮运动SIGTERM已上电就绪'
    assert confirmation['motion_window_ms'] == 3000
    assert confirmation['transmitter_stays_on'] and confirmation['signal_reconnected']
    assert confirmation['receiver_stays_powered'] and confirmation['automatic_sigterm_stimulus']
