...
REMOTE = '/home/cat/.cache/robot-control/staging/p103-uart-window-bcd4cfe9-uart-a3-20260917'
...
def main():
    ...
    assert confirmation['statement'] == 'F5零目标UART静默恢复已上电就绪'
    assert confirmation['receiver_stays_powered'] and confirmation['signal_only_stimulus']
    assert confirmation['usb_ground_power_unchanged'] and confirmation['transmitter_stays_on']
