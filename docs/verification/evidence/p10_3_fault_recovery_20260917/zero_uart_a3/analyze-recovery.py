...
def main(incomplete=False):
    ...
    if incomplete:
        ...
        assert phases == [('fault_ready', 'sbus'), ('fault_observed', 'sbus'), ('release_fault', 'sbus')], phases
        assert 'operation=control_hil_recovery context=phase=2 source_fault=2 ' in log
...
if __name__ == '__main__':
    ...
    parser.add_argument("--incomplete", action="store_true", help="Audit F5 A3 partial-frame discontinuity exit; never grant recovery acceptance")
