...
def main():
    ...
    print('F4 A4：右轮运动 SBUS 发射机失联停车 — 右轮正向 ≤5rpm / 不足8秒（7.95秒自动截止），左轮始终静止；反馈静止容差±1.5rpm；总就绪窗口60秒。\n')
    ...
    print('摇杆中立、CH6 松开、X1 已解除复位，遥控器和接收机均已开启且连接正常；接收机全程供电，能够在 POWER_OFF_READY 提示后长按电源键完成关机，驱动已上电就绪，能看清本窗口。')
    ...
    confirmation = dict(statement='F4右轮运动SBUS失联已上电就绪', raw_user_statement=answer,
                        confirmation_source='Local terminal START plus typed X1已复位，关闭遥控器 after F4 A4 checklist',
