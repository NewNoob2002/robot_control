#!/usr/bin/env python3
"""Execute the authorized three-hour zero-motion soak retest once."""
import hashlib
import json
import os
import sys
...
AUTHORIZATION = BASE / "authorization_retest.json"
OUTPUT = BASE / "overnight_retest_once"
...
marker = BASE / "run_retest_once.marker"
