#!/usr/bin/env python3
"""Enable the exact one-shot moving X1 authorization without operating CAN."""
import hashlib
import json
import subprocess
...
assert authorization["motion_args"] == ["--interface", "can0", "--target-once", "2:5", "--duration-ms", "3000"]
...
print("PASS: one moving X1 trial authorized; no CAN operation started")
