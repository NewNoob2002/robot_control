...
BASE = Path('/tmp/robot-control-qualifications/review-online-ef9837d751f9')
ELF = BASE / 'robot-control-zlac-qualification'
EXPECTED = 'ef9837d751f9038ddadfa76b42107a526b740e6d65f84f0aa8e468ccd236fff0'
authorization = json.loads((BASE / 'authorization_right.json').read_text())
