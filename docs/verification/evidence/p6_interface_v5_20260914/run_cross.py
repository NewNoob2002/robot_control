...
evidence = root / 'docs/verification/evidence/p6_interface_v5_20260914'
command = ['docker', 'run', '--rm', '--user', str(os.getuid()) + ':' + str(os.getgid()),
           ...
           '--mount', 'type=bind,source=' + str(root / 'out/build-inputs/interface-v5') + ',target=/workspace,readonly',
           ...
           'python3', '/workspace/out/hil/interface-v5/cross.py']
with (evidence / 'external_cross.log').open('w') as log:
