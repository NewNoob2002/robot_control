...
SERIAL = '207F346D5650'
BASE = '/tmp/robot-control-qualifications/p66-manual-tpdo-8ca2c0250736'
...
assert authorization['elf_sha256'] == '8ca2c0250736e792ecb0b7067973ce2547f7e2d6fb9c38d0147a5788ade34c8a'
...
def validate_frame(frame):
    ...
    if command == 0x40:
        allowed = {(0x1017, 0), (0x603F, 0), (0x6041, 0), (0x60FF, 1), (0x60FF, 2)}
    ...
    allowed = {(0x2B, 0x1017, 0, 0), (0x2B, 0x1017, 0, 500),
               (0x23, 0x1800, 1, 0x80000181), (0x23, 0x1800, 1, 0x181),
               (0x2F, 0x1800, 2, 255), (0x2B, 0x1800, 5, 100),
               (0x2F, 0x1A00, 0, 0), (0x2F, 0x1A00, 0, 2)}
    allowed |= {(0x23, 0x1A00, subindex, descriptor) for subindex in (1, 2)
                for descriptor in (0x60410020, 0x606C0320)}
    ...
    while True:
        ...
        if label == 'jcan_out':
            ...
            if message == 'CAPTURE_READY':
                ...
                started = True
            elif message.startswith('MANUAL_ROTATION_READY'):
                pass
