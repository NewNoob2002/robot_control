...
out = Path('out/p93-calibration-prep')
command = ['ssh', '-o', 'BatchMode=yes', '-o', 'ConnectTimeout=5', 'robot-dev',
           'timeout --signal=TERM --kill-after=3s 50s python3 /home/cat/.cache/robot-control/staging/p93-calibration-bd76d3fd/target_capture.py']
