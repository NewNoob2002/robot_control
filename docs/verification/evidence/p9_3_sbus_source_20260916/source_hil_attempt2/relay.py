...
out = Path('out/p93-source-hil-attempt2')
command = ['ssh', '-o', 'BatchMode=yes', '-o', 'ConnectTimeout=5', 'robot-dev',
           'timeout --signal=TERM --kill-after=3s 80s python3 /home/cat/.cache/robot-control/staging/p93-source-e7b4cded-attempt2/target_capture.py']
