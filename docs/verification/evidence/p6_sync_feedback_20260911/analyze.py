...
assert len(commands) == 1 and commands[0][2] == bytes.fromhex("23 FF 60 03 05 00 00 00")
start = commands[0][0]
zero = next(f[0] for f in frames if f[0] > start and f[1] == 0x601 and f[2] == bytes.fromhex("23 FF 60 03 00 00 00 00"))
