...
BASE = Path('/tmp/robot-control-qualifications/zero-recovery-31d2d0848e93')
ELF = BASE / 'robot-control-zlac-qualification'
EXPECTED = '31d2d0848e9330f6f910e642d47bccb6552ca112cefa36214defa646c524b7e3'
authorization = json.loads((BASE / 'authorization_physical_nmt_stop_once.json').read_text())
assert authorization['args'] == ['--interface', 'can0', '--nmt-stop-once', '2:5', '--duration-ms', '1000']
...
for p in Path('/proc').iterdir():
    ...
    try:
        ...
        pass
OUT = BASE / 'physical_nmt_stop_once'
