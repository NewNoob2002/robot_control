...
SERIAL = '207F346D5650'
BASE = '/tmp/robot-control-qualifications/zero-recovery-31d2d0848e93'
...
assert authorization['elf_sha256'] == '31d2d0848e9330f6f910e642d47bccb6552ca112cefa36214defa646c524b7e3'
...
def validate_frame(frame):
    ...
    global frames, downloads, uploads, nmts, nonzero, terminal, recovery, nmt_stop
    frames += 1
...
try:
    ...
    assert started and nonzero == 1 and terminal == 2 and nmt_stop == 1
    ...
    (OUT / 'coordinator_result.json').write_text(json.dumps({'go_sent': go, 'executor_started': started, 'error': error, 'frames': frames, 'downloads': downloads, 'uploads': uploads, 'nmt_frames': nmts, 'nonzero_requests': nonzero, 'cleanup_shutdown_requests': terminal, 'disable_voltage_requests': recovery, 'nmt_stop_requests': nmt_stop}, indent=2))
