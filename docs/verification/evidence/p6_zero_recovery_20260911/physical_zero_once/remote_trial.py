...
authorization = json.loads((BASE / 'authorization_physical_zero_once.json').read_text())
assert authorization['args'] == ['--interface', 'can0', '--zero-sequence']
