...
root = out.parents[3]
manifest = json.loads((out / "manifest_budget.json").read_text())
base = manifest["base"]
...
(out/"target_vcan_budget.log").write_text(result.stdout)
(out/"target_vcan_budget.stderr").write_text(result.stderr)
