...
DURATION = 780  # Reviewed target window plus bounded startup/cleanup margin.
    ...
    with (HERE / 'session.jsonl').open('wb') as raw, (HERE / 'session.stderr').open('wb') as stderr, \
        ...
        try:
            ...
            write_json('preflight.json', {
                ...
                'operator_state': {'drive_power': 'ON', 'x1_locked': False, 'continuous_can_traffic': 'produced by RK3588 during target run'},
