#!/usr/bin/env python3
"""Execute the authorized three-hour zero-motion soak v4 once."""
import hashlib
import json
import os
import sys
...
BASE = Path("/tmp/robot-control-qualifications/zero-motion-soak-v4-bb4f44251672")
SCRIPT = BASE / "phase6_zero_motion_soak.py"
SCRIPT_SHA = "b3473b8fe9b19e3a6e36d3f540bd65aa6ae1fbe5753f192ba75a34a77e5b0f08"
