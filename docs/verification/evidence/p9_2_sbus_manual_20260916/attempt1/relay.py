...
out = Path('out/p92-manual-30s-20260916')
command = ['ssh', '-o', 'BatchMode=yes', '-o', 'ConnectTimeout=5', 'robot-dev',
           'timeout --signal=TERM --kill-after=3s 50s python3 /home/cat/.cache/robot-control/staging/p92-1c235cc-6d6cb2fb/target_capture_30s.py']
