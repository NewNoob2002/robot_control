...
for name,remote in [('authorization.json','authorization_interface_loss_manual_v2_once.json'),('remote_trial.py','remote_interface_loss_manual_v2_once.py'),('interface_toggle.py','interface_toggle_manual_v2_once.py')]:
    source=out/name
