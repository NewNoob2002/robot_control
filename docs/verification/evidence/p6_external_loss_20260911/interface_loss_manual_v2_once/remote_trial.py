...
authorization = json.loads((BASE / 'authorization_interface_loss_manual_v2_once.json').read_text())
...
for p in Path('/proc').iterdir():
    ...
    try:
        ...
        pass
OUT = BASE / 'interface_loss_manual_v2_once'
OUT.mkdir(exist_ok=False)
gate = BASE / 'interface_manual_v2_gate'
