...
for name,remote in [('authorization.json','authorization_interface_loss_manual_once.json'),('remote_trial.py','remote_interface_loss_manual_once.py'),('interface_toggle.py','interface_toggle_manual_once.py')]:
    source=out/name
