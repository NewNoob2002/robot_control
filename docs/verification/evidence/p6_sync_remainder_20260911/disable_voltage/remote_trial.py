...
BASE = Path('/tmp/robot-control-qualifications/sync-remainder-fa1944fdba2d')
ELF = BASE / 'robot-control-zlac-qualification'
EXPECTED = 'fa1944fdba2dd98cbe8ebbeebc34174baafe1eba0d930b33ae306fbd47091205'
authorization = json.loads((BASE / 'authorization_disable_voltage.json').read_text())
